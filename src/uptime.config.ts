...
const workerConfig: WorkerConfig = {
  ...
  callbacks: {
    onStatusChange: async (_env: any, _monitor: any, _isUp: boolean, _timeIncidentStart: number, _timeNow: number, _reason: string) => {},
    onIncident: async (_env: any, _monitor: any, _timeIncidentStart: number, _timeNow: number, _reason: string) => {},
  },
}
